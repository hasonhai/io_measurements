...
chmod a+x disktest_sshless.sh
echo "Setup the host"
for HOST in $HOSTLIST; do
    ./disktest_sshless.sh $CONF $USER $KEY $HOST setup-host
done

echo "Setup the test"
for HOST in $HOSTLIST; do
    ./disktest_sshless.sh $CONF $USER $KEY $HOST setup-test
done
...
for HOST in $HOSTLIST; do
    ./disktest_sshless.sh $CONF $USER $KEY $HOST collect-data
done

echo "Clean the host"
for HOST in $HOSTLIST; do
    ./disktest_sshless.sh $CONF $USER $KEY $HOST clean
done
